    ...
    function salesHeader() {
      return `<header class="site-header"><div class="wrap header-inner"><a class="brand" href="/" aria-label="Toppapps, início da loja de ${esc(CATEGORY.short)}"><span class="brand-mark" aria-hidden="true">${esc(CATEGORY.short.slice(0,2))}</span><span>TOPPAPPS <em>· ${esc(CATEGORY.short)}</em></span></a><nav class="main-nav" id="main-nav" aria-label="Navegação da oferta"><a href="#metodo">Método</a><a href="#conteudo">Conteúdo</a><a href="#oferta">Acesso</a><a href="/suporte">Suporte</a></nav><div class="header-actions"><a class="button sales-header-cta" href="#oferta">Quero acessar agora</a><button class="menu-toggle" type="button" aria-expanded="false" aria-controls="main-nav">Menu</button></div></div></header>`;
    }
...
</div><img class="sales-media" src="/product/hero.webp" alt="Mãos tatuadas conduzindo uma conversa no celular, sobre a bancada do estúdio." width="1792" height="1008"></div></section>
${confidence()}
...
<img class="sales-media tall" src="/product/pain.webp" alt="Celular com mensagens acumuladas sobre a bandeja do estúdio." width="1792" height="1008">
</div></section>
...
<div>
<img class="sales-media" src="/product/mockup.webp" alt="Guia impresso WhatsApp que Fecha ao lado de um celular." width="1600" height="1200">
<img class="sales-media" style="margin-top:14px;height:220px" src="/product/notebook.webp" alt="Caderno aberto com checklist de briefing." width="1728" height="1152">
</div></div></section>
...
<img class="sales-media" src="/product/cover.webp" alt="Capa do guia WhatsApp que Fecha." width="900" height="520">
...
<p class="note-soft">Garantia de 7 dias pelo CDC. Se o material não servir, escreva para ${SUPPORT_EMAIL}.</p>
</aside>
</div></section>
