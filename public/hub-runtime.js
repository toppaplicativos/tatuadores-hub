    ...
    function salesPage(product) {
      ...
      const samples = [
        ...
        ['Briefing', 'Mandei a foto da referência aqui', 'A referência ajuda, mas ainda falta o local e o tamanho aproximado em centímetros. Sem isso o orçamento fica chute. Me manda essas duas informações que eu te respondo com o valor e o tempo de sessão.'],
        ['Preço', 'Deu pra ver o que eu mandei?', 'Pelo tamanho, local e estilo que você mandou, o valor fica [valor]. Entra desenho, sessão de cerca de [tempo] e os cuidados básicos. O orçamento vale [prazo]. Se fizer sentido, o próximo passo é o sinal de [sinal] para reservar o horário.'],
        ['Sinal', 'Como faço pra garantir o horário?', 'Para segurar a data, o estúdio trabalha com sinal de [sinal]. Ele reserva o horário e o tempo de desenho. O restante fica para o dia da sessão. Se quiser seguir, eu te mando a chave e a data que ainda está aberta.'],
        ['Está caro', 'Achei um pouco caro pra mim', 'Entendo o susto com o número. Esse valor cobre tempo de desenho, sessão, material e o cuidado que o local pede. Não costumo reduzir o escopo só para caber num preço — mas posso te mostrar um recorte menor, se você quiser começar por uma peça mais simples.'],
        ['Vou pensar', 'Vou pensar e te falo', 'Tranquilo pensar. Eu deixo este orçamento válido até [prazo]. Se quiser ajustar tamanho ou local, me chama que eu refaço o valor. Se não for o momento, sem problema — o horário volta para a agenda.'],
        ['Silêncio', 'Ok, valeu', 'Oi, [nome]. Deixei o orçamento da [peça] aqui. Ainda faz sentido para você? Se sim, me diz e a gente vê a data. Se mudou de ideia, pode responder só um “agora não” que eu encerro por aqui.'],
        ['Pós-sessão', 'Valeu pela sessão', 'Sessão feita. Qualquer dúvida de cuidado, me chama nesta conversa. Se quiser retorno de acompanhamento, o prazo usual é [prazo]. Quando a pele assentar, se quiser conversar sobre a próxima, é só puxar o fio.']
      ];
      const chapters = [
...
<p class="sales-kicker"><svg class="wa-mark" viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.435 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg> WhatsApp que Fecha — 100 mensagens para tatuadores</p>
...
<p class="eyebrow sales-kicker"><svg class="wa-mark" viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.435 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg> Exemplos reais do WhatsApp</p>
<h2>Assim chega a mensagem — e assim você responde.</h2>
<p class="copy">Oito trechos reais do banco, no visual da conversa. Os colchetes são para você preencher. Isto não é depoimento de cliente — é o próprio material, à vista.</p>
<div class="msg-grid">${samples.map(([s,incoming,msg]) => `<article class="wa-chat"><header class="wa-bar"><span class="wa-avatar"><svg class="wa-mark" viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.435 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg></span><div><strong>${esc(s)}</strong><span>online</span></div></header><div class="wa-thread"><div class="wa-in">${esc(incoming)}</div><div class="wa-out">${esc(msg)}<span class="wa-meta">14:32 <svg class="wa-ticks" viewBox="0 0 16 11" aria-hidden="true"><path fill="currentColor" d="M11.07 1.14 5.4 7.07 3.1 4.86l-.9.86 3.2 3.07 6.57-6.79-.9-.86zm3.16 0-5.67 5.93-.7-.67-.9.86 1.6 1.53 6.57-6.79-.9-.86z"/></svg></span></div></div></article>`).join('')}</div>
</div></section>
